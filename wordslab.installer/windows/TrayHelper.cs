...
{
    // https://github.com/Squirrel/Squirrel.Windows/blob/76c87af6f389bea69576c738ef46574b2945b0ba/src/Squirrel/TrayHelper.cs

    // Use in conjunction with : https://github.com/hardcodet/wpf-notifyicon/
    // https://github.com/davidortinau/WeatherTwentyOne/tree/main/src/WeatherTwentyOne/Platforms/Windows/NativeWindowing
        ...
        public unsafe void RemoveDeadEntries(List<string> executablesInPackage, string rootAppDirectory, string currentAppVersion)
        {
            ...
            fixed (byte* b = iconStreamData)
            {
                ...
                for (int i = 0; i < header.count; i++)
                {
                    ...
                    {
                        throw new Exception("Corrupted IconStreams regkey, bailing");
                        return;
                    }
                    ...
                    {
                        throw new Exception("Failed to parse IconStreams regkey", ex);
                    }
                }
