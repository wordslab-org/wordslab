...
{
    public class GoogleCloudDisk : VirtualDisk
    {
        ...
        private GoogleCloudDisk(string vmName, VirtualDiskFunction function, string storagePath, int totalSizeGB, bool isSSD) :
